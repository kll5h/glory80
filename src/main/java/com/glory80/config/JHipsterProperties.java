...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "glory80@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "glory80 API";

        private String description = "glory80 API documentation";
